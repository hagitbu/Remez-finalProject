...
$(document).ready(function(){
    $("button").click(function(){
        $(".nested-list").append('<li><a href="#">New list item</a></li>');
    });
});


function appendLi(subStage) {
    $(".nested-list").append('<li><a href="#"> subStage </a></li>');
    document.getElementsByClassName("nested-list").innerHTML = appendLi(subStage);
}
